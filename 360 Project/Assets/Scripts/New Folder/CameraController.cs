...
public class CameraController : MonoBehaviour
{
    ...
    void Update()
    {
        if(tourManager.isCameraMove)
        {
            ...
            {
                transform.localEulerAngles = new Vector3(transform.localEulerAngles.x + Input.GetAxis("Mouse Y") * Time.deltaTime * rotateSpeed,
                transform.localEulerAngles.y + Input.GetAxis("Mouse X") * Time.deltaTime * rotateSpeed, 0);
            }
